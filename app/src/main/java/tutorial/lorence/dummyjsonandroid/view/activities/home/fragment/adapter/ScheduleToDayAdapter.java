package tutorial.lorence.dummyjsonandroid.view.activities.home.fragment.adapter;
...
public class ScheduleToDayAdapter extends RecyclerView.Adapter<ScheduleToDayAdapter.MyViewHolder> {
    ...
    public ScheduleToDayAdapter(Context context, FragmentSchedule fragment, List<Schedule> items) {
        mContext = context;
        mFragment = fragment;
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.card_schedule_item_today, parent, false);
